      ...
      <div className="grid gap-6 xl:grid-cols-2">
        ...
        <div id="captcha-settings" className="scroll-mt-6"><Card className="h-full border-l-4 border-l-amber-500 p-5 shadow-sm">
          ...
          <div className="mt-5 grid gap-4 sm:grid-cols-2">
            ...
            <Field label="Turnstile 并行度" hint="控制浏览器线程池数量。建议 2，机器吃紧用 1，范围 1–10"><NumberInput value={form.solver_browser_threads ?? 2} min={1} max={10} onChange={(value) => set('solver_browser_threads', value)} /></Field>
